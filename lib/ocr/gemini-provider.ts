...
import { dadosExtraidosSchema, type DadosExtraidos, type OcrConfianca, type OcrProvider } from "@/lib/ocr/provider";
...
export const geminiOcrProvider: OcrProvider<DadosExtraidos> = {
  async extrair({ buffer, mimeType }) {
    return executarExtracaoGemini({
      ...
      versaoPrompt: VERSAO,
      schemaZod: dadosExtraidosSchema,
      calcularConfianca,
      rotulo: "cupom",
    });
  },
